...
build_file_block = "\t\t" + build_file_app_id + " /* NewFileData.swift in Sources */ = {isa = PBXBuildFile; fileRef = " + file_ref_id + " /* NewFileData.swift */; };\n"
build_file_block += "\t\t" + build_file_ext_id + " /* NewFileData.swift in Sources */ = {isa = PBXBuildFile; fileRef = " + file_ref_id + " /* NewFileData.swift */; };\n"

content = content.replace("/* End PBXBuildFile section */", build_file_block + "/* End PBXBuildFile section */")

# 3. Add to PBXFileReference
ref_block = "\t\t" + file_ref_id + " /* NewFileData.swift */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = NewFileData.swift; sourceTree = \"<group>\"; };\n"
...
if group_match:
    content = content.replace(group_match.group(0), group_match.group(0) + "\n\t\t\t\t" + file_ref_id + " /* NewFileData.swift */,")
...
if app_phase:
    ...
    new_app = old_app.replace("files = (" + files_str + ");", "files = (" + files_str + "\n\t\t\t\t" + build_file_app_id + " /* NewFileData.swift in Sources */,\n\t\t\t);")
...
if ext_phase:
    ...
    new_ext = old_ext.replace("files = (" + files_str_ext + ");", "files = (" + files_str_ext + "\n\t\t\t\t" + build_file_ext_id + " /* NewFileData.swift in Sources */,\n\t\t\t);")
